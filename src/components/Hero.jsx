      ...
      <div className="relative z-10 max-w-4xl text-center space-y-6 mt-12">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
          ...
          <button 
            ...
            className="border-2 border-white/90 hover:border-white text-white font-semibold text-sm sm:text-base px-8 py-3.5 rounded-none transition-all hover:bg-white/10 backdrop-blur-xs"
          >
            Book a Visit
          </button>
          ...
          <button 
            onClick={onOpenEnquire}
            className="bg-white/20 hover:bg-white/30 border border-white/40 text-white font-semibold text-sm sm:text-base px-8 py-3.5 rounded-none transition-all backdrop-blur-md shadow-lg"
          >
            Enquire Now
          </button>
        </div>
